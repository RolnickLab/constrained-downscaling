...
def add_arguments():
    ...
    parser.add_argument("--dataset", default='dataset32', help="choose a data set to use")
    parser.add_argument("--scale", default='minmax_fixed', help="standard, minmax, none")
    parser.add_argument("--model", default='conv_gru_det')
    parser.add_argument("--model_id", default='nu_aaai_symp_cnn_sum_rerun')
    ...
    parser.add_argument("--constraints", default='mult')
