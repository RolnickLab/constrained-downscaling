...
def add_arguments():
    ...
    parser.add_argument("--dataset", default='dataset31', help="choose a data set to use")
    parser.add_argument("--scale", default='minus_to_one_fixed', help="standard, minmax, none")
    parser.add_argument("--model", default='res_4up')
    parser.add_argument("--model_id", default='nu_aaai_symp_cnn_sumsing_16')
    ...
    parser.add_argument("--upsampling_factor", default=16, type=int)
    parser.add_argument("--noise", default=False)
    parser.add_argument("--constraints", default='mult_single')
