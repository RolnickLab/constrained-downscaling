...
def add_arguments():
    ...
    parser.add_argument("--dataset", default='dataset33', help="choose a data set to use")
    parser.add_argument("--scale", default='minus_to_one_fixed', help="standard, minmax, none")
    parser.add_argument("--model", default='time_end_to_end')
    parser.add_argument("--model_id", default='nu_aaai_symp_time_gh_long_4_0')
    parser.add_argument("--number_channels", default=64, type=int)
    parser.add_argument("--number_residual_blocks", default=3, type=int)#""!!change
    parser.add_argument("--upsampling_factor", default=4, type=int)
    parser.add_argument("--noise", default=False)
    parser.add_argument("--constraints", default='enfrce_op')
